...
$sql = "SELECT email, name, hash FROM user WHERE active is NOT NULL";
...
while($row = mysqli_fetch_assoc($stmt)){
    ...
    $mail->Body = 'Your free copy of  XKCD is attached. Have fun!<br><br> <img src='.$image.'> <br><br> <a href='.$verify.'://'.$_SERVER['HTTP_HOST'].'/assignment/unsubs.php?id='.$row['hash'].'>Click here to Unsubscribe.</a>'."\r\n" ;
