    ...
    <div id="wrap">
        ...
        <?php
         ...
         if (isset($_GET['id']) && !empty($_GET['id'])) {
            ...
            if ($conn->query("SELECT hash, active FROM user WHERE hash='" . $hash . "' AND active IS NOT NULL")->num_rows > 0) {
                
                $conn->query("UPDATE user SET active = NULL WHERE hash='".$hash."' AND active IS NOT NULL");
